    ...
    public class UserRepository : BaseRepository, IUserRepository
    {
        ...
        public void Delete(int id)
        {
            try
            {
                ...
                _commandText = "USP_Parking_User_Delete";
        ...
        public List<UserEntity> Get()
        {
            ...
            try
            {
                ...
                _commandText = "USP_Parking_User_Get";
        ...
        public UserEntity GetById(int id)
        {
            ...
            try
            {
                ...
                _commandText = "USP_Parking_User_GetById";
                using (SqlConnection sqlConnection = new SqlConnection(_connectionString))
                {
                    SqlCommand sqlCommand = new SqlCommand(_commandText, sqlConnection);
        ...
        public void Post(UserEntity entity)
        {
            try
            {
                ...
                _commandText = "USP_Parking_User_Post";
                SqlConnection sqlConnection = new SqlConnection(_connectionString);
                SqlCommand sqlCommand = new SqlCommand(_commandText, sqlConnection);
        ...
        public void Put(UserEntity entity)
        {
            try
            {
                ...
                _commandText = "USP_Parking_User_Put";
                SqlConnection sqlConnection = new SqlConnection(_connectionString);
                SqlCommand sqlCommand = new SqlCommand(_commandText, sqlConnection);
