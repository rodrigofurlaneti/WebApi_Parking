...
namespace Parking.Infrastructure.Repository.Profile
{
    public class ProfileRepository : BaseRepository, IProfileRepository
    {
        ...
        public void Delete(int id)
        {
            try
            {
                ...
                _commandText = "USP_Parking_Profile_Delete";
        ...
        public List<ProfileEntity> Get()
        {
            ...
            try
            {
                ...
                _commandText = "USP_Parking_Profile_Get";
        ...
        public ProfileEntity GetById(int id)
        {
            ...
            try
            {
                ...
                _commandText = "USP_Parking_Profile_GetById";
                using (SqlConnection sqlConnection = new SqlConnection(_connectionString))
                {
                    SqlCommand sqlCommand = new SqlCommand(_commandText, sqlConnection);
        ...
        public void Post(ProfileEntity entity)
        {
            try
            {
                ...
                _commandText = "USP_Parking_Profile_Post";
                SqlConnection sqlConnection = new SqlConnection(_connectionString);
                SqlCommand sqlCommand = new SqlCommand(_commandText, sqlConnection);
        ...
        public void Put(ProfileEntity entity)
        {
            try
            {
                ...
                _commandText = "USP_Parking_Profile_Put";
                SqlConnection sqlConnection = new SqlConnection(_connectionString);
                SqlCommand sqlCommand = new SqlCommand(_commandText, sqlConnection);
